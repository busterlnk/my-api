 ...
 */
final class Version20231214195240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "chatoperator" (operatorid INT NOT NULL, vclogin VARCHAR(255) NOT NULL, vcpassword VARCHAR(255) NOT NULL, vcemail VARCHAR(255) DEFAULT NULL, PRIMARY KEY(operatorid))');
